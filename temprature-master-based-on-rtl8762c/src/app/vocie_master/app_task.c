...
#define VS1053B_TASK_PRIORITY         1         // vs1053b task prio
#define APP_TASK_STACK_SIZE           256 * 5   //!<  Task stack size
#define VS1053B_TASK_STACK_SIZE       256 * 4   //!<  Task stack size
