...
#else
    .load_base = (uint32_t)__flash_start_load_ad__,
    .exe_base = SystemInit, //(uint32_t)IMAGE_FLASH_START_ADDR,
#endif
...
#pragma section = ".intvec"
    ...
    uint32_t AppVectorSize = &__ram_vector_table_length__;
#endif
    uint32_t i             = 0;
