...
/* OTP start addr: 0x00200164, size: 0x368 */
typedef struct otp_struct
{
    ...
    uint32_t platform_cfg_rsvd5: 26;     //adc_channel, 0x002003c4
    ...
    uint8_t  phy_init_cfg_rsvd0[3];     //start addr = 0x002004a8, size=0x24
    ...
    uint8_t  phy_init_cfg_rsvd1[29];
}  __attribute__((packed))T_OTP_CFG;
/*end otp, addr = 0x002004cc*/
