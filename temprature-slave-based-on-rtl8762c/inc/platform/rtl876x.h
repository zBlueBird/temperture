...
typedef struct                                          /*!< SYS_BLKCTRL Structure      */
{
    union
    {
        ...
        struct
        {
            ...
            __IO uint32_t r_bt_ahb_wait_cnt: 5;
    ...
    __IO uint32_t    RSVD5[32];                            /*!< 0x2AC~0x328   */
    union
    {
...
typedef struct
{
    ...
    __IO uint32_t RESV0;            /*!< 0x0C */
    __IO uint32_t CR3;              /*!< 0x10 */
    __IO uint32_t I2S_CTRL;         /*!< 0x14 */
    __IO uint32_t AUDIO_CTRL;       /*!< 0x18 */
    __IO uint32_t CLK_CTRL;         /*!< 0x1C */
    __IO uint32_t DAC_CTRL;         /*!< 0x20 */
    __IO uint32_t ADC_CTRL;         /*!< 0x24 */
} CODEC_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t RGB_LEN;          /*!< 0x24 */
    __I  uint32_t DATA_CNT;         /*!< 0x28 */
} LCD_TypeDef;
...
#define CODEC_REG_BASE              0x40022000UL
...
#define IR_REG_BASE                 0x40003000UL
...
#define SPIC_FLASH_REG_BASE         0x40080000UL
...
#define LCD_REG_BASE                    0x40024800UL
...
#define SPIC                            ((SPIC_TypeDef            *) SPIC_FLASH_REG_BASE)
#define CODEC                           ((CODEC_TypeDef*) CODEC_REG_BASE)
#define CODEC_EQ1                       ((CODEC_EQTypeDef*) CODEC_EQ1_REG_BASE)
#define CODEC_EQ2                       ((CODEC_EQTypeDef*) CODEC_EQ2_REG_BASE)
#define CODEC_EQ3                       ((CODEC_EQTypeDef*) CODEC_EQ3_REG_BASE)
#define CODEC_EQ4                       ((CODEC_EQTypeDef*) CODEC_EQ4_REG_BASE)
#define CODEC_EQ5                       ((CODEC_EQTypeDef*) CODEC_EQ5_REG_BASE)
#define I2S0                            ((I2S_TypeDef*) I2S0_REG_BASE)
#define I2S1                            ((I2S_TypeDef*) I2S1_REG_BASE)
#define LCD                             ((LCD_TypeDef*) LCD_REG_BASE)
